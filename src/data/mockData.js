export const categoriesResponse = {
  data: [
    { categoryId: 1, categoryName: "Skincare", subtitle: "Serums, creams & treatments" },
    { categoryId: 2, categoryName: "Makeup", subtitle: "Color & complexion" },
    { categoryId: 3, categoryName: "Fragrance", subtitle: "Signature scents" },
    { categoryId: 4, categoryName: "Haircare", subtitle: "Shine & strength" },
  ],
};
...
export const productsResponse = {
  data: [
    ...
    },
    {
      ...
      price: 44,
      categoryId: 4,
      imageUrl: "https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=600&h=600&fit=crop",
...
export function getCategoryLabel(categoryId) {
  const found = categories.find((x) => x.categoryId === categoryId);
  return found?.categoryName ?? `Category ${categoryId}`;
}
